...
class QdrantSearcher:
    def __init__(self, collection_name = "yes24_v2_collection", database_path="/data/qdrant_db"):
        self.client = QdrantClient(path=database_path)
        self.collection_name = collection_name
        print('Embeddings loaded successfully.')

    def search_items(self, search_item, search_keywords, top_k=5, must_not_conditions=[]): #search_item is numpy(embedded vector)
    ...
    #For Fast API
    def find_memorial_book_real_service(self, book_id, top_k = 30):
...
#     test_obj = QdrantSearcher()
#
#     while True:
#         book_id = int(input("Enter yout book id : "))
#
#         for item in test_obj.find_memorial_book_real_service(book_id, 5057):
#             print(item)
#         print('\n')